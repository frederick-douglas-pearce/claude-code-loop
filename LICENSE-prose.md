...
The material this licence covers is licensed under the
...
This summary is not a substitute for the licence. The full legal text is at
<https://creativecommons.org/licenses/by/4.0/legalcode>, and it governs.
...
two licences: an image, a rendered card, a data file. The directory is a boundary that can be
checked by looking at a path.
