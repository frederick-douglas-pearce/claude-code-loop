...
default. **This is the one rule at this gate whose doubt subtracts**, so it needs saying that the
...
**Keep the floor lens out of any later tier decision read off this corpus.** A mandated lens fires
