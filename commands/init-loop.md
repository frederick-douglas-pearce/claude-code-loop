...
| `DESIGN_AGENT` | <TODO(init-loop): user-global subagent, or remove if none> | reviews plans pre-implementation (steps 4/5); also rules on scope when a BLOCKING code-review finding raises a design question (step 8) |
